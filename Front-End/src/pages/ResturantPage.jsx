...
import HeroDisplay from '../components/Resturant/HeroDisplay';
import OrderTitle from '../components/Resturant/OrderTitle';
import OrderBody from '../components/Resturant/OrderBody';
      ...
      <nav className="bg-white border-b border-gray-300 shadow-md">
        <div className="max-w-5xl mx-auto px-4 py-2 flex items-center justify-around">
          ...
          <div className="relative flex items-center flex-grow mx-4">
            ...
            >
              <img className="w-5" src={locpin} alt="Location Pin" />
